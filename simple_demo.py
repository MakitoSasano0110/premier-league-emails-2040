#!/usr/bin/env python3
"""
Simple demo of the Premier League Email RAG Chatbot without heavy dependencies
"""
import os
import glob
import re
...
class SimpleEmailSearch:
    ...
    def generate_answer(self, query: str, search_results: List[Dict]) -> str:
        ...
        for i, result in enumerate(search_results, 1):
            ...
            if any(word in query.lower() for word in ['契約', '年俸', 'salary']):
    ...
    def extract_contract_info(self, body: str) -> str:
        ...
        # Extract bonuses
        bonus_matches = re.findall(r'Bonus: £([\d,]+)', body)
        if bonus_matches:
...
def main():
    ...
    while True:
        ...
        print("例: Mohamed Salah Jr.の契約条件は？")
        print("例: Gabriel Fernandezの移籍金は？")
        print("例: Arsenal contract")
